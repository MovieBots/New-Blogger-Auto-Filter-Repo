...
auth_channel = environ.get('AUTH_CHANNEL', '-1002739491658') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://arpitgavla121:g8I3aRSiy9ymAdDt@cluster0.z3usqpw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://telegra.ph/file/378a08d7e1bca338db963-d05a2ded13e2ffa4dd.jpg')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+UJDqKurKwQYyOGNl') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://brave-maud-talkmovies-de8f4596.koyeb.app/")
